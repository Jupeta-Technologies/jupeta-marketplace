...
export default function ProfilePage() {
  ...
  return (
    <div className="container mx-auto px-4 py-8">
      ...
      <div className="grid grid-cols-1 lg:grid-cols-4 gap-8" style={{display:'flex', flexDirection:'row', marginTop:'48px', gap:'48px'}}>
        {/* Sidebar */}
        <div className="lg:col-span-1 myacc_panel">
          <div className="bg-white rounded-lg shadow-md p-6">
            <nav>
              <ul className="space-y-2">
                <li
                  onClick={() => setActiveTab('profile')}
                  className={`w-full flex items-center gap-2 text-left px-4 py-2 rounded-md cursor-pointer transition-colors ${
                    activeTab === 'profile'
                      ? 'active'
